...
class CreateMenusTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('menus')->insert([
            ...
            ['categoria'=>'S', 'nombre'=>'Roles', 'icono'=>'fas fa-users', 'route'=>'roles', 'url'=>'roles', 'orden'=>2, 'user_id'=>1],
            ['categoria'=>'S', 'nombre'=>'Usuarios', 'icono'=>'fas fa-user', 'route'=>'users', 'url'=>'users', 'orden'=>3, 'user_id'=>1],
            ...
            ['categoria'=>'A', 'nombre'=>'Tipos de Muestreo', 'icono'=>'fas fa-bars', 'route'=>'muestreos', 'url'=>'muestreos', 'orden'=>4, 'user_id'=>1],
            ['categoria'=>'A', 'nombre'=>'Recursos', 'icono'=>'fas fa-bars', 'route'=>'recursos', 'url'=>'recursos', 'orden'=>5, 'user_id'=>1],
            
            ['categoria'=>'O', 'nombre'=>'Virus', 'icono'=>'fas fa-bars', 'route'=>'virus', 'url'=>'virus', 'orden'=>1, 'user_id'=>1],
            ['categoria'=>'O', 'nombre'=>'Linajes', 'icono'=>'fas fa-bars', 'route'=>'linajes', 'url'=>'linajes', 'orden'=>2, 'user_id'=>1],
            ['categoria'=>'O', 'nombre'=>'Carga de Datos', 'icono'=>'fas fa-bars', 'route'=>'cargas', 'url'=>'cargas', 'orden'=>3, 'user_id'=>1],
        ]);
    }
