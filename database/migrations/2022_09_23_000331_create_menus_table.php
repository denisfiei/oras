...
class CreateMenusTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('menus')->insert([
            ...
            ['categoria'=>'S', 'nombre'=>'Configuración', 'icono'=>'fas fa-cog', 'route'=>'configuracion', 'url'=>'configuracion', 'orden'=>5, 'user_id'=>1],
            ['categoria'=>'S', 'nombre'=>'Logs', 'icono'=>'fas fa-bullhorn', 'route'=>'logs', 'url'=>'logs', 'orden'=>6, 'user_id'=>1],

            ['categoria'=>'A', 'nombre'=>'Paises', 'icono'=>'fas fa-globe-americas', 'route'=>'home', 'url'=>'home', 'orden'=>1, 'user_id'=>1],
            ['categoria'=>'A', 'nombre'=>'Laboratorios', 'icono'=>'fas fa-flask', 'route'=>'users', 'url'=>'users', 'orden'=>2, 'user_id'=>1],
