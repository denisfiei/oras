new Vue({
    ...
    data: {
        ...
        menu: {
            'categoria': null,
            'categoria_text': 'Seleccione una opción',
            'nombre': null,
            'icono': null,
            'route': null,
            'url': null,
        ...
        categorias: [
            { id: 'S', text: 'Menu del Sistema' },
            { id: 'A', text: 'Menu Administrativo' },
            { id: 'O', text: 'Menu Operativo' }
        ],
    },
    created() {
        this.Buscar();
    ...
    methods: {
        ...
        Buscar(page) {
            urlBuscar = 'menus/buscar?page=' + page;
            axios.post(urlBuscar, {
                search: this.search.datos
            }).then(response => {
                this.listRequest = response.data.menus.data;
                this.to_pagination = response.data.menus.to;
