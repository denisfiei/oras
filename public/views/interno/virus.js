new Vue({
    ...
    methods: {
        ...
        Buscar(page) {
            urlBuscar = 'virus/buscar?page=' + page;
            axios.post(urlBuscar, {
                search: this.search.datos
            }).then(response => {
                this.listRequest = response.data.virus.data;
                this.to_pagination = response.data.virus.to;
        ...
        Modal(size, metodo, id, seleccion) {
            ...
            switch (metodo) {                
                case 'create':
                    this.modal.title = 'NUEVO VIRUS';
                    break;

                case 'edit':
                    this.modal.title = 'EDITAR VIRUS';
                    this.virus.nombre = seleccion.nombre;
                    this.virus.codigo = seleccion.codigo;
                    break;

                case 'delete':
                    this.modal.title = 'ELIMINAR VIRUS';
                    this.virus.nombre = seleccion.nombre;
                    break;
        ...
        Store(form) {
            ...
            axios.post('virus/store', {
                nombre: this.virus.nombre,
                codigo: this.virus.codigo
            }).then(response=> {
