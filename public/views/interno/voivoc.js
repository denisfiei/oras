new Vue({
    ...
    methods: {
        ...
        Buscar(page) {
            urlBuscar = 'voi_voc/buscar?page=' + page;
            axios.post(urlBuscar, {
                search: this.search.datos
            }).then(response => {
                this.listRequest = response.data.voivoc.data;
                this.to_pagination = response.data.voivoc.to;
        ...
        Modal(size, metodo, id, seleccion) {
            ...
            switch (metodo) {                
                ...
                default:
                    this.variante.nombre = seleccion.nombre;
                    break;
            }
        },
        CloseModal() {
        ...
        Store(form) {
            ...
            axios.post('voi_voc/store', {
                codigo: this.variante.codigo,
                tipo: this.variante.tipo
            }).then(response=> {
