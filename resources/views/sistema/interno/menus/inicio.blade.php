...
<div class="content-body" id="form_menus">
    <div class="container pd-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
                <h4 class="mg-b-0 tx-spacing--1"><i class="fas fa-th-list"></i> MENUS DEL SISTEMA</h4>
            </div>
            <div class="d-none d-md-block">
                <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5" @click="Modal('modal-md', 'create', null, null)"><i class="fas fa-plus wd-10 mg-r-5"></i> Nuevo Menu</button>
            </div>
        </div>
    </div>

    @include('sistema.interno.menus.modal')

    <div class="col-lg-12 col-xl-12 mg-t-10">
        <div class="card mg-b-10">
            <div class="card-header d-flex align-items-center justify-content-between pd-r-12">
                <h6 class="mg-b-0">LISTA DE MENUS DEL SISTEMA</h6>
                    ...
                    <table class="table table-bordered table-hover mg-b-0">
                        ...
                        <tbody>
                            ...
                            <tr class="my_vue" v-for="(data, index) in listRequest" style="display:none;">
                                ...
                                <td class="text-right">@{{Categoria(data.categoria)}}</td>
...
@section('js')
    <script src="{{asset('views/interno/menu.js?v=1.0.0')}}"></script>
@endsection