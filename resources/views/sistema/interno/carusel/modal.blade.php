    ...
    <div class="modal-dialog" role="document" :class="modal.size">
        ...
        <div class="modal-content" v-if="modal.method == 'create'" id="create">
            <div class="modal-body pd-20 pd-sm-40">
                ...
                <div>
                    <h4 class="text-center mb-1">NUEVO CARUSEL</h4>
                    ...
                    <div class="row">
                            ...
                            <div data-label="FORMULARIO" class="df-example demo-forms">
                                <div class="row row-sm">
                                    <div class="form-group form-group-sm col-md-12 mb-3">
                                        ...
                                        <input type="text" id="titulo" v-model="carusel.titulo" class="form-control" :class="[errors.titulo ? 'border-error' : '']">
                                        <div class="input-error" v-if="errors.titulo">@{{ errors.titulo[0] }}</div>
                                    </div>
                                    <div class="form-group form-group-sm col-md-12 mb-3">
                                        <label class="form-label mb-0" for="resaltar">TEXTO RESALTADO </label>
                                        <input type="text" id="resaltar" v-model="carusel.resaltar" class="form-control" :class="[errors.resaltar ? 'border-error' : '']">
                                        <div class="input-error" v-if="errors.resaltar">@{{ errors.resaltar[0] }}</div>
                                    </div>
                                    <div class="form-group form-group-sm col-md-12 mb-3">
                                        <label class="form-label mb-0" for="descripcion">DESCRIPCIÓN <span class="obligatorio">(*)</span></label>
                                        <textarea id="descripcion" v-model="carusel.descripcion" class="form-control" :class="[errors.descripcion ? 'border-error' : '']"></textarea>
                                    ...
                                    <div class="form-group form-group-sm col-md-12 mb-3">
                                        ...
                                        <input type="text" id="boton" v-model="carusel.boton" class="form-control" :class="[errors.boton ? 'border-error' : '']" maxlength="9">
                                        <div class="input-error" v-if="errors.boton">@{{ errors.boton[0] }}</div>
                                    </div>
                                    <div class="form-group form-group-sm col-md-12 mb-3" v-if="carusel.boton">
                                        <label class="form-label mb-0" for="link">LINK </label>
                                        <input type="text" id="link" v-model="carusel.link" class="form-control" :class="[errors.link ? 'border-error' : '']">
                                    ...
                                    <div class="form-group form-group-sm col-md-12 mb-3">
                                        ...
                                        <select id="mostrar" v-model="carusel.mostrar" class="form-select" :class="[errors.mostrar ? 'border-error' : '']">
                        ...
                        <div class="col-lg-5 col-md-12 mb-3">
                            <div data-label="IMAGEN" class="df-example demo-forms">
                                <div class="row row-sm">
                                    <div class="form-group form-group-sm col-md-12 mb-3">
                                        <label class="form-label mb-0" for="imagen">IMAGEN &nbsp; <i class="fas fa-exclamation-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Dimención de la imagen 1920x1280"></i> <span class="obligatorio"> &nbsp;(*)</span></label>
        ...
        <div class="modal-content" v-else-if="modal.method == 'edit'" id="edit">
            <div class="modal-body pd-20 pd-sm-40">
                ...
                <div>
                    <h4 class="text-center mb-1">EDITAR CLIENTE</h4>
                    <div class="obligatorio text-end mb-4 mt-3" style="max-height: 15px;">
                        (*)<small style="vertical-align: top;"> Obligatorio</small>
                    </div>
        ...
        <div class="modal-content" v-else-if="modal.method == 'delete'" id="delete">
            <div class="modal-body pd-20 pd-sm-40">
                ...
                <div>
                    <h4 class="text-center mb-4">ELIMINAR CARUSEL</h4>
                    <p class="text-center mb-4">
                        ¿ Realmente desea eliminar el Carusel: <br>
                        <strong> @{{carusel.titulo}}</strong> ?
                    </p>
