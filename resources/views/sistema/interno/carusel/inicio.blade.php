...
<div class="content-body" id="form_carusel">
    <div class="container pd-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
                <h4 class="mg-b-0 tx-spacing--1"><i data-feather="columns"></i> Carusel</h4>
            </div>
            <div class="d-none d-md-block">
                <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5" @click="Modal('modal-lg', 'create', null, null)"><i class="fas fa-plus wd-10 mg-r-5"></i> Nuevo Carusel</button>
            </div>
        </div>
    </div>

    @include('sistema.interno.carusel.modal')

    <div class="col-lg-12 col-xl-12 mg-t-10">
        <div class="card mg-b-10">
            <div class="card-header d-flex align-items-center justify-content-between pd-r-12">
                <h6 class="mg-b-0">LISTA DE CARUSELES</h6>
                    ...
                    <table class="table table-bordered table-hover mg-b-0">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-right" width="20%">Titulo</th>
                                <th class="text-center" width="35%">Descripción</th>
                                <th class="text-center" width="20%">Botón</th>
                                <th class="text-center" width="10%">Mostrar </th>
                        ...
                        <tbody>
                            ...
                            <tr class="my_vue" v-for="(data, index) in listRequest" style="display:none;">
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" class="btn_opt" data-bs-toggle="tooltip" title="Editar" @click="Modal('modal-lg', 'edit', data.id, data)"><i class="text-secondary fas fa-pencil-alt"></i></a>
                                    <a href="javascript:void(0)" class="btn_opt ms-2" data-bs-toggle="tooltip" title="Dar de Baja" @click="Modal('modal-lgmd', 'delete', data.id, data)"><i class="text-danger far fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
@section('js')
    <script src="{{asset('views/interno/carusel.js?v=1.0.0')}}"></script>
@endsection