...
<div class="content-body" id="form_roles">
    <div class="container pd-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
                <h4 class="mg-b-0 tx-spacing--1"><i class="fas fa-tasks"></i> ROLES DEL SISTEMA</h4>
            </div>
                    ...
                    <table class="table table-bordered table-hover mg-b-0">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-center" width="20%">Cuentas Activas</th>
                                <th class="text-center" width="20%">Permisos</th>
...
@section('js')
    <script src="{{asset('views/interno/roles.js?v=1.0.0')}}"></script>
@endsection