...
<div class="content-body" id="form_avisos">
    <div class="container pd-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
                <h4 class="mg-b-0 tx-spacing--1"><i data-feather="message-square"></i> Avisos</h4>
            </div>
            <div class="d-none d-md-block">
                <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5" @click="Modal('modal-lg', 'create', null, null)"><i class="fas fa-plus wd-10 mg-r-5"></i> Nuevo Aviso</button>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12 col-xl-12 mg-t-10">
        <div class="card mg-b-10">
            <div class="card-header d-flex align-items-center justify-content-between pd-r-12">
                <h6 class="mg-b-0">LISTA DE AVISOS</h6>
...
@section('js')
    <script src="{{asset('views/interno/avisos.js?v=1.0.0')}}"></script>
@endsection