                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 py-3">
                        <div class="row secuencia">
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="pb-3">
                                    <a href="https://app.powerbi.com/view?r=eyJrIjoiODU5NGYyMTMtOGUzYS00MjRiLWI3NTktYmY5ZThjZWFjMmZiIiwidCI6IjNhODk3YjhiLTJmNmItNGI0OS05NGExLWJlN2RhMzMzZTM5ZiJ9&pageName=ReportSectiona6526770a8b29ef84369" class="button_link text-white"><i class="fas fa-arrow-right"></i> Ver Dashboard</a>
                                </div>
                                <p class="subtitle_pais pb-0">
                                ...
                                <div class="pb-3">
                                    <a href="https://app.powerbi.com/view?r=eyJrIjoiODU5NGYyMTMtOGUzYS00MjRiLWI3NTktYmY5ZThjZWFjMmZiIiwidCI6IjNhODk3YjhiLTJmNmItNGI0OS05NGExLWJlN2RhMzMzZTM5ZiJ9&pageName=ReportSection" class="button_link text-white"><i class="fas fa-arrow-right"></i> Ver Dashboard</a>
                                </div>
                            </div>
                        </div>
                    </div>
